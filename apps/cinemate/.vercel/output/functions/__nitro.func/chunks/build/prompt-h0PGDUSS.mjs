...
import { k as isUnicodeSupported, l as colors, o as getDefaultExportFromCjs } from './server.mjs';
...
(function(t) {
  ...
  t.exports = u, u.eastAsianWidth = function(e) {
    var s2 = e.charCodeAt(0), C = e.length == 2 ? e.charCodeAt(1) : 0, D = s2;
...
const v = 10, L = (t = 0) => (u) => `\x1B[${u + t}m`, M = (t = 0) => (u) => `\x1B[${38 + t};5;${u}m`, T = (t = 0) => (u, F, e) => `\x1B[${38 + t};2;${u};${F};${e}m`, r = { modifier: { reset: [0, 0], bold: [1, 22], dim: [2, 22], italic: [3, 23], underline: [4, 24], overline: [53, 55], inverse: [7, 27], hidden: [8, 28], strikethrough: [9, 29] }, color: { black: [30, 39], red: [31, 39], green: [32, 39], yellow: [33, 39], blue: [34, 39], magenta: [35, 39], cyan: [36, 39], white: [37, 39], blackBright: [90, 39], gray: [90, 39], grey: [90, 39], redBright: [91, 39], greenBright: [92, 39], yellowBright: [93, 39], blueBright: [94, 39], magentaBright: [95, 39], cyanBright: [96, 39], whiteBright: [97, 39] }, bgColor: { bgBlack: [40, 49], bgRed: [41, 49], bgGreen: [42, 49], bgYellow: [43, 49], bgBlue: [44, 49], bgMagenta: [45, 49], bgCyan: [46, 49], bgWhite: [47, 49], bgBlackBright: [100, 49], bgGray: [100, 49], bgGrey: [100, 49], bgRedBright: [101, 49], bgGreenBright: [102, 49], bgYellowBright: [103, 49], bgBlueBright: [104, 49], bgMagentaBright: [105, 49], bgCyanBright: [106, 49], bgWhiteBright: [107, 49] } };
Object.keys(r.modifier);
const Z = Object.keys(r.color), H = Object.keys(r.bgColor);
[...Z, ...H];
function U() {
...
const q = U(), p = /* @__PURE__ */ new Set(["\x1B", "\x9B"]), J = 39, b = "\x07", W = "[", Q = "]", I = "m", w = `${Q}8;;`, N = (t) => `${p.values().next().value}${W}${t}${I}`, j = (t) => `${p.values().next().value}${w}${t}${b}`, X = (t) => t.split(" ").map((u) => c(u)), _ = (t, u, F) => {
  const e = [...u];
  let s2 = false, C = false, D = c($(t[t.length - 1]));
  for (const [i, o] of e.entries()) {
    const E = c(o);
    if (D + E <= F ? t[t.length - 1] += o : (t.push(o), D = 0), p.has(o) && (s2 = true, C = e.slice(i + 1).join("").startsWith(w)), s2) {
...
const R = Symbol("clack:cancel");
function g(t, u) {
  t.isTTY && t.setRawMode(u);
}
const V = /* @__PURE__ */ new Map([["k", "up"], ["j", "down"], ["h", "left"], ["l", "right"]]), tD = /* @__PURE__ */ new Set(["up", "down", "left", "right", "space", "enter"]);
class h {
  constructor({ render: u, input: F = stdin, output: e = stdout, ...s2 }, C = true) {
  ...
  on(u, F) {
    var _a;
    const e = (_a = this.subscribers.get(u)) != null ? _a : [];
  ...
  emit(u, ...F) {
    var _a;
    const e = (_a = this.subscribers.get(u)) != null ? _a : [], s2 = [];
...
`).length - 1;
  ...
  render() {
    var _a;
    const u = P((_a = this._render(this)) != null ? _a : "", process.stdout.columns, { hard: true });
...
class iD extends h {
  constructor(u) {
    var _a;
    super(u, false), this.cursor = 0, this.options = u.options, this.value = [...(_a = u.initialValues) != null ? _a : []], this.cursor = Math.max(this.options.findIndex(({ value: F }) => F === u.cursorAt), 0), this.on("key", (F) => {
      F === "a" && this.toggleAll();
    }), this.on("cursor", (F) => {
      switch (F) {
        case "left":
...
const s = (c2, fallback) => unicode ? c2 : fallback;
...
`;
        ...
        case "cancel": {
          return `${title}${colors.gray(S_BAR)} ${colors.strikethrough(
            colors.dim((_a2 = this.value) != null ? _a2 : "")
...
const confirm = (opts) => {
  var _a, _b, _c;
  const active = (_a = opts.active) != null ? _a : "Yes";
  const inactive = (_b = opts.inactive) != null ? _b : "No";
  return new sD({
    active,
    inactive,
    initialValue: (_c = opts.initialValue) != null ? _c : true,
    render() {
      const title = `${colors.gray(S_BAR)}
${symbol(this.state)} ${opts.message}
`;
...
const select = (opts) => {
  const opt = (option, state) => {
    var _a;
    const label = (_a = option.label) != null ? _a : String(option.value);
    switch (state) {
      case "active": {
...
const multiselect = (opts) => {
  ...
  const opt = (option, state) => {
    var _a2;
    const label = (_a2 = option.label) != null ? _a2 : String(option.value);
    switch (state) {
      case "active": {
  ...
  return new iD({
    ...
    required: (_a = opts.required) != null ? _a : true,
...
export { prompt };
//# sourceMappingURL=prompt-h0PGDUSS.mjs.map
