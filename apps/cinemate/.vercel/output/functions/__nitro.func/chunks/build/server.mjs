import { version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, defineComponent, useSSRContext, computed, h, useAttrs, toValue as toValue$1, toRef, provide, inject, unref, shallowReactive, Suspense, nextTick, Fragment, Transition, hasInjectionContext, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, onServerPrefetch, createApp, effectScope, reactive, getCurrentScope, isRef, isReactive, toRaw, shallowRef, onErrorCaptured, onScopeDispose, isReadonly, toRefs, markRaw, openBlock, createBlock, createCommentVNode, createTextVNode, toDisplayString, isShallow } from 'vue';
...
import { promisify, deprecate, types, formatWithOptions } from 'node:util';
import { format as format$1 } from 'node:url';
import { isIP } from 'node:net';
import { statSync, promises, createReadStream } from 'node:fs';
import { basename, sep } from 'node:path';
import { k as baseURL, l as createHooks, c as createError$1, m as getContext, s as sanitizeStatusCode, n as toRouteMatcher, o as createRouter$1 } from '../_/nitro.mjs';
...
const mr = Symbol.toStringTag, yi = n((i) => typeof i == "object" && typeof i.append == "function" && typeof i.delete == "function" && typeof i.get == "function" && typeof i.getAll == "function" && typeof i.has == "function" && typeof i.set == "function" && typeof i.sort == "function" && i[mr] === "URLSearchParams", "isURLSearchParameters"), yr = n((i) => i && typeof i == "object" && typeof i.arrayBuffer == "function" && typeof i.type == "string" && typeof i.stream == "function" && typeof i.constructor == "function" && /^(Blob|File)$/.test(i[mr]), "isBlob"), Qs = n((i) => typeof i == "object" && (i[mr] === "AbortSignal" || i[mr] === "EventTarget"), "isAbortSignal"), Ys = n((i, o2) => {
  ...
  async formData() {
    ...
    const { toFormData: a2 } = await import('./multipart-parser-V5A2619M.mjs');
...
t(l, "p"), g(l, "_getFetch");
const s$1 = l(), d = !o && globalThis.Headers || ye, A = !o && globalThis.AbortController || Mn;
...
function createNodeFetch() {
  ...
  return function nodeFetchWithKeepAlive(input, init2) {
    return s$1(input, { ...nodeFetchOptions, ...init2 });
  };
}
...
const unhead_AL8UaeJVTK = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DkPz2Gfc.mjs')
  },
  {
    name: "item-name",
    path: "/item/:name()",
    component: () => import('./_name_-BT81Wu3y.mjs')
  },
  {
    name: "now-playing",
    path: "/now-playing",
    component: () => import('./now-playing-C-9ZTQdH.mjs')
  },
  {
    name: "popular",
    path: "/popular",
    component: () => import('./popular-DVhNbVZk.mjs')
  },
  {
    name: "search",
    path: "/search",
    component: () => import('./search-DJyqt0ZX.mjs')
  },
  {
    name: "top-rated",
    path: "/top-rated",
    component: () => import('./top-rated-Bz8SnCdw.mjs')
  },
  {
    name: "upcoming",
    path: "/upcoming",
    component: () => import('./upcoming-CwPy2ehh.mjs')
  }
];
...
const revive_payload_server_h11jpJqaCL = /* @__PURE__ */ defineNuxtPlugin({
  ...
  return defineComponent({
    ...
    setup(props, { slots }) {
      ...
      function shouldPrefetch(mode) {
        var _a2, _b2;
        return !prefetched.value && (typeof props.prefetchOn === "string" ? props.prefetchOn === mode : ((_a2 = props.prefetchOn) == null ? void 0 : _a2[mode]) ?? ((_b2 = options.prefetchOn) == null ? void 0 : _b2[mode])) && (props.prefetch ?? options.prefetch) !== false && props.noPrefetch !== true && props.target !== "_blank" && !isSlowConnection();
      }
...
const slideovers_1z5RiiOzVB = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const modals_ez06ElrhSj = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const config$3 = { "inherit": _inherit, "current": _current, "transparent": _transparent, "black": _black, "white": _white, "slate": _slate, "gray": _gray, "zinc": _zinc, "neutral": _neutral, "stone": _stone, "red": _red, "orange": _orange, "amber": _amber, "yellow": _yellow, "lime": _lime, "green": _green, "emerald": _emerald, "teal": _teal, "cyan": _cyan, "sky": _sky, "blue": _blue, "indigo": _indigo, "violet": _violet, "purple": _purple, "fuchsia": _fuchsia, "pink": _pink, "rose": _rose, "primary": _primary, "cool": _cool };
const colors_LrCmCv0wTd = /* @__PURE__ */ defineNuxtPlugin(() => {
  const appConfig2 = useAppConfig();
  useNuxtApp();
  const root = computed(() => {
    const primary = get(config$3, appConfig2.ui.primary);
    const gray = get(config$3, appConfig2.ui.gray);
    if (!primary) {
    ...
    return `:root {
${Object.entries(primary || config$3.green).map(([key, value]) => `--color-primary-${key}: ${parseConfigValue(value)};`).join("\n")}
--color-primary-DEFAULT: var(--color-primary-500);

${Object.entries(gray || config$3.cool).map(([key, value]) => `--color-gray-${key}: ${parseConfigValue(value)};`).join("\n")}
}
...
const plugin_server_Iv3P6KyB1P = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  var _a2;
...
const plugin_OM5prFOQkG = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
    var _a2, _b2;
    const config2 = /* @__PURE__ */ useRuntimeConfig();
...
const plugins = [
  unhead_AL8UaeJVTK,
  plugin$1,
  revive_payload_server_h11jpJqaCL,
  plugin,
  components_plugin_KR1HBZs4kY,
  slideovers_1z5RiiOzVB,
  modals_ez06ElrhSj,
  colors_LrCmCv0wTd,
  plugin_server_Iv3P6KyB1P,
  plugin_OM5prFOQkG
];
...
_sfc_main$8.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@2.18.7_axios@1.7.7_change-case@5.4.4_magicast@0.3.5_rollup@4.24.3_ts-node@10.9.1_@sw_x2wxiupvk3xu33mpalbku64iwm/node_modules/@nuxt/ui/dist/runtime/components/elements/Link.vue");
...
function clearBleed(index2, string, open, close, replace) {
  return index2 < 0 ? open + string + close : open + replaceClose(index2, string, close, replace) + close;
}
...
function createConsola(options = {}) {
  ...
  const consola2 = createConsola$1({
    ...
    prompt: (...args) => import('./prompt-h0PGDUSS.mjs').then((m) => m.prompt(...args)),
    reporters: options.reporters || [
            ...
            nuxt.runWithContext(() => {
              useHead({
                style: [
                  () => {
                    const sep2 = "";
                    let css = Array.from(ssrCSS.values()).sort().join(sep2);
                    if (options.cssLayer) {
                      css = `@layer ${options.cssLayer} {${sep2}${css}${sep2}}`;
                    }
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@2.18.7_axios@1.7.7_change-case@5.4.4_magicast@0.3.5_rollup@4.24.3_ts-node@10.9.1_@sw_x2wxiupvk3xu33mpalbku64iwm/node_modules/@nuxt/ui/dist/runtime/components/elements/Icon.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const __nuxt_component_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$4]]);
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@2.18.7_axios@1.7.7_change-case@5.4.4_magicast@0.3.5_rollup@4.24.3_ts-node@10.9.1_@sw_x2wxiupvk3xu33mpalbku64iwm/node_modules/@nuxt/ui/dist/runtime/components/elements/Avatar.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@2.18.7_axios@1.7.7_change-case@5.4.4_magicast@0.3.5_rollup@4.24.3_ts-node@10.9.1_@sw_x2wxiupvk3xu33mpalbku64iwm/node_modules/@nuxt/ui/dist/runtime/components/elements/Badge.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/@nuxt+ui@2.18.7_axios@1.7.7_change-case@5.4.4_magicast@0.3.5_rollup@4.24.3_ts-node@10.9.1_@sw_x2wxiupvk3xu33mpalbku64iwm/node_modules/@nuxt/ui/dist/runtime/components/navigation/HorizontalNavigation.vue");
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UHorizontalNavigation, mergeProps({
        links: headerLinks,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NavigationBar = _sfc_main$3;
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D6ky2Hq9.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CGFvUf6P.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.13.2_@parcel+watcher@2.4.1_@types+node@22.8.6_encoding@0.1.13_eslint@9.14.0_jiti@2.4.0_2ldf6laugzhuk4tl3mhztg3bsq/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../../node_modules/.pnpm/nuxt@3.13.2_@parcel+watcher@2.4.1_@types+node@22.8.6_encoding@0.1.13_eslint@9.14.0_jiti@2.4.0_2ldf6laugzhuk4tl3mhztg3bsq/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { On as O, _export_sfc as _, __nuxt_component_0$3 as a, __nuxt_component_1$2 as b, appConfig as c, defineStore as d, entry$1 as default, __nuxt_component_0$2 as e, useUI as f, useInjectButtonGroup as g, twJoin as h, getNuxtLinkProps as i, br as j, isUnicodeSupported as k, colors as l, mergeConfig as m, nuxtLinkProps as n, getDefaultExportFromCjs as o, twMerge as t, useHead as u };
